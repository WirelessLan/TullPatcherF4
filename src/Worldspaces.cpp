...
namespace WorldSpaces {
	...
	void ReadConfigs() {
		...
		for (auto& iter : dir_iter) {
			...
			logger::info("=========== Reading Worldspace config file: {} ===========", path);
			ReadConfig(path);
			logger::info("");
		}
	}
	...
	void Patch() {
		logger::info("======================== Start preparing patch for Worldspace ========================");

		Prepare(g_configVec);

		logger::info("======================== Finished preparing patch for Worldspace ========================");
		logger::info("");

		logger::info("======================== Start patching for Worldspace ========================");
		...
		logger::info("======================== Finished patching for Worldspace ========================");
		logger::info("");
